...
// WSDL     : http://127.0.0.1:8081/oxhide/services/ApplicationServer?wsdl
//  >Import : http://127.0.0.1:8081/oxhide/services/ApplicationServer?wsdl:0
//  >Import : http://127.0.0.1:8081/oxhide/services/ApplicationServer?wsdl:1
//  >Import : http://127.0.0.1:8081/oxhide/services/ApplicationServer?wsdl:2
//  >Import : http://127.0.0.1:8081/oxhide/services/ApplicationServer?wsdl:3
//  >Import : http://127.0.0.1:8081/oxhide/services/ApplicationServer?wsdl:4
//  >Import : http://127.0.0.1:8081/oxhide/services/ApplicationServer?wsdl:5
//  >Import : http://127.0.0.1:8081/oxhide/services/ApplicationServer?wsdl:6
//  >Import : http://127.0.0.1:8081/oxhide/services/ApplicationServer?wsdl:7
//  >Import : http://127.0.0.1:8081/oxhide/services/ApplicationServer?wsdl:8
//  >Import : http://127.0.0.1:8081/oxhide/services/ApplicationServer?wsdl:9
//  >Import : http://127.0.0.1:8081/oxhide/services/ApplicationServer?wsdl:10
//  >Import : http://127.0.0.1:8081/oxhide/services/ApplicationServer?wsdl:11
//  >Import : http://127.0.0.1:8081/oxhide/services/ApplicationServer?wsdl:12
//  >Import : http://127.0.0.1:8081/oxhide/services/ApplicationServer?wsdl:13
//  >Import : http://127.0.0.1:8081/oxhide/services/ApplicationServer?wsdl:14
//  >Import : http://127.0.0.1:8081/oxhide/services/ApplicationServer?wsdl:15
//  >Import : http://127.0.0.1:8081/oxhide/services/ApplicationServer?wsdl:16
//  >Import : http://127.0.0.1:8081/oxhide/services/ApplicationServer?wsdl:17
//  >Import : http://127.0.0.1:8081/oxhide/services/ApplicationServer?wsdl:18
//  >Import : http://127.0.0.1:8081/oxhide/services/ApplicationServer?wsdl:19
//  >Import : http://127.0.0.1:8081/oxhide/services/ApplicationServer?wsdl:20
// Encoding : UTF-8
// Version  : 1.0
// (2012-8-15 9:35:13 - - $Rev: 10138 $)
// ************************************************************************ //

unit ApplicationServer;
...
type
  ...
  entry                = class;                 { "http://application.server.oxhide.sxsihe.com"[Cplx] }
  entry2               = class;                 { "http://application.server.oxhide.sxsihe.com"[Cplx] }
  ...
  ArrayOfString = array of WideString;          { "http://application.server.oxhide.sxsihe.com"[GblCplx] }
  anyType2anyTypeMap = array of entry;          { "http://application.server.oxhide.sxsihe.com"[GblCplx] }


  // ************************************************************************ //
  // XML       : entry, <complexType>
  // Namespace : http://application.server.oxhide.sxsihe.com
  // ************************************************************************ //
  ...
  anyType2booleanMap = array of entry2;         { "http://application.server.oxhide.sxsihe.com"[GblCplx] }
  ...
  ArrayOfApplication = array of Application_;   { "http://domain.application.oxhide.sxsihe.com"[GblCplx] }
  ...
  // style     : document
  // binding   : ApplicationServerHttpBinding
  // service   : ApplicationServer
  // port      : ApplicationServerHttpPort
  // URL       : http://127.0.0.1:8081/oxhide/services/ApplicationServer
  // ************************************************************************ //
  ApplicationServerPortType = interface(IInvokable)
  ['{0029F8C3-8BDC-D0C8-4050-B098110D9355}']
    function  findObjectBykey(const in0: WideString): Application_; stdcall;
    function  getAll: ArrayOfApplication; stdcall;
    function  findObjectsByCondition(const in0: ConditionBlock; const in1: anyType2booleanMap): ArrayOfApplication; stdcall;
  end;

function GetApplicationServerPortType(UseWSDL: Boolean=System.False; Addr: string=''; HTTPRIO: THTTPRIO = nil): ApplicationServerPortType;


implementation
  uses SysUtils;

function GetApplicationServerPortType(UseWSDL: Boolean; Addr: string; HTTPRIO: THTTPRIO): ApplicationServerPortType;
const
  defWSDL = 'http://127.0.0.1:8081/oxhide/services/ApplicationServer?wsdl';
  defURL  = 'http://127.0.0.1:8081/oxhide/services/ApplicationServer';
  defSvc  = 'ApplicationServer';
  defPrt  = 'ApplicationServerHttpPort';
var
  RIO: THTTPRIO;
begin
  Result := nil;
  ...
  if HTTPRIO = nil then
    ...
    RIO := HTTPRIO;
  try
    Result := (RIO as ApplicationServerPortType);
    if UseWSDL then
    begin
...
initialization
  InvRegistry.RegisterInterface(TypeInfo(ApplicationServerPortType), 'http://application.server.oxhide.sxsihe.com', 'UTF-8');
  InvRegistry.RegisterDefaultSOAPAction(TypeInfo(ApplicationServerPortType), '');
  InvRegistry.RegisterInvokeOptions(TypeInfo(ApplicationServerPortType), ioDocument);
  InvRegistry.RegisterExternalParamName(TypeInfo(ApplicationServerPortType), 'findObjectBykey', 'out_', 'out');
  InvRegistry.RegisterExternalParamName(TypeInfo(ApplicationServerPortType), 'getAll', 'out_', 'out');
  InvRegistry.RegisterExternalParamName(TypeInfo(ApplicationServerPortType), 'findObjectsByCondition', 'out_', 'out');
  RemClassRegistry.RegisterXSInfo(TypeInfo(ArrayOfString), 'http://application.server.oxhide.sxsihe.com', 'ArrayOfString');
  RemClassRegistry.RegisterXSInfo(TypeInfo(anyType2anyTypeMap), 'http://application.server.oxhide.sxsihe.com', 'anyType2anyTypeMap');
  RemClassRegistry.RegisterXSClass(entry, 'http://application.server.oxhide.sxsihe.com', 'entry');
  RemClassRegistry.RegisterXSInfo(TypeInfo(anyType2booleanMap), 'http://application.server.oxhide.sxsihe.com', 'anyType2booleanMap');
  RemClassRegistry.RegisterXSClass(entry2, 'http://application.server.oxhide.sxsihe.com', 'entry2', 'entry');
  RemClassRegistry.RegisterXSInfo(TypeInfo(ArrayOfApplication), 'http://domain.application.oxhide.sxsihe.com', 'ArrayOfApplication');
