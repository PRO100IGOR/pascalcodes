...
// WSDL     : http://202.99.202.106:8081/oxhide/services/UserServer?wsdl
//  >Import : http://202.99.202.106:8081/oxhide/services/UserServer?wsdl:0
// Encoding : UTF-8
// Version  : 1.0
// (2012-6-6 11:28:08 - - $Rev: 10138 $)
// ************************************************************************ //
...
type
  ...
  // URL       : http://202.99.202.106:8081/oxhide/services/UserServer
  // ************************************************************************ //
  ...
  ['{9752F248-09DE-6C49-BBD4-A6967012A604}']
    ...
    procedure unSendData(const in0: WideString); stdcall;
...
const
  defWSDL = 'http://202.99.202.106:8081/oxhide/services/UserServer?wsdl';
  defURL  = 'http://202.99.202.106:8081/oxhide/services/UserServer';
  defSvc  = 'UserServer';
