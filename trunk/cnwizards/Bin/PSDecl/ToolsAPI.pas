...
================================================================================
* 软件名称：CnPack IDE 专家包
* 单元名称：在脚本中使用的 ToolsAPI For D6/CB7 and UP 单元声明
...
* 本 地 化：
* 单元标识：$Id: ToolsAPI.pas 763 2011-02-07 14:18:23Z liuxiao@cnpack.org $
...
const
  ...
  // CLX or VCL.  Use dAny for a wizard that doesn't care which desigher under
  // which it is invoked.
...
type
  ...
  INTAFormEditor = interface(IUnknown)
    ...
    property FormDesigner: IDesigner read GetFormDesigner;
  end;
...
{$ENDIF}
  ...
  IOTAServices = interface(IOTAServices50)
