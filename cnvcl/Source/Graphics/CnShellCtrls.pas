...
================================================================================
* 软件名称：界面控件包
* 单元名称：ShellCtrls 控件单元
* 单元作者：Borland Delphi Visual Component Library
* 备    注：由 周劲羽 从 Delphi 7 中移植而来，以实现 D5 的兼容
*           移植时删除了 TShellComboBox 控件
* 开发平台：PWin2000Pro + Delphi 5.0
* 兼容测试：PWin9X/2000/XP + Delphi 5
* 本 地 化：该单元中的字符串均符合本地化处理方式
* 单元标识：$Id: CnShellCtrls.pas 761 2011-02-07 14:08:58Z liuxiao@cnpack.org $
* 修改记录：2003.12.03
*               移植自 Delphi 7
================================================================================
|</PRE>}
...
procedure TCnCustomShellTreeView.MouseUp(Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
...
(*
procedure TCnCustomShellTreeView.NodeDeleted(Sender: TObject; Node: TTreeNode);
begin
  if Assigned(Node.Data) then
  begin
    TShellFolder(Node.Data).Free;
